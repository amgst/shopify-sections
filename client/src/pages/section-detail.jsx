...
export default function SectionDetail() {
    ...
    const sectionId = (params === null || params === void 0 ? void 0 : params.slug) ? params.slug.split('-')[0] : "";
    ...
    const handleDownload = async () => {
        ...
        toast({
            ...
            description: `${section === null || section === void 0 ? void 0 : section.title} has been downloaded successfully.`,
        });
    };
    if (isLoading) {
            ...
            <div className="sticky top-24 bg-card border border-card-border rounded-xl p-6 space-y-6">
              <div>
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  {section.isPremium && (<Badge className="bg-accent text-accent-foreground" data-testid="badge-premium">
                      Premium
                    </Badge>)}
                </div>
              ...
              {relatedSections.length > 0 && (<div className="pt-6 border-t border-border">
                  <h3 className="font-semibold text-foreground mb-4" data-testid="text-related-title">
                    Related Sections
                  </h3>
                  <div className="space-y-4">
                    {relatedSections.map((related) => (<SectionCard key={related.id} {...related}/>))}
                  </div>
                </div>)}
            </div>
          </div>
